                ...
                <View style={localStyles.loggedInContainer}>
                    <View style={localStyles.navHeader}>
                        ...
                        <DrawerButton
                            ...
                            onPress={this.props.route.params.openDrawer}
                        />
                        {
                            this.state.requests && this.state.requests.length > 0 ?
                                <TouchableOpacity onPress={() => this.handleOpenModal()}
                                                  style={localStyles.RequestOverlay}>
                                    <Ionicons style={{paddingHorizontal: 2, paddingVertical: 0}}
                                              name="ios-notifications" size={20} color={theme.icons.color}/>
                    ...
                    <View style={localStyles.HeaderCont}>
                        <Image style={localStyles.profilePic}
                               source={this.props.userData.photoSource ? {uri: this.props.userData.photoSource} : defPhoto}/>
                    ...
                    <ScrollView style={localStyles.ScrollView}>
                        {this.state.friends.map((friend, i) => (
                            <TouchableOpacity key={i} onPress={() => this.props.navigation.navigate('Profile', {
                                screen: "OtherProfile", params: {
                                    email: friend.email,
                                }
                            })}
                            >
                                <View style={localStyles.friendCont}>
                                    <Image style={localStyles.friendPic}
                                           source={friend.photoSource ? {uri: friend.photoSource} : defPhoto}/>
